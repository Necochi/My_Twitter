...
(function (window, document) {
  ...
  function handleTouchEnd(e) {
    ...
    if (swipeUnit === 'vh') {
      swipeThreshold = Math.round((swipeThreshold / 100)
      * document.documentElement.clientHeight); // get percentage of viewport height in pixels
    }
    if (swipeUnit === 'vw') {
      swipeThreshold = Math.round((swipeThreshold / 100)
      * document.documentElement.clientWidth); // get percentage of viewport height in pixels
    }
    ...
    if (eventType !== '') {
      ...
      startEl.dispatchEvent(new CustomEvent(
        eventType, { bubbles: true, cancelable: true, detail: eventData }));
    }
...
// на touch двигать слайдер
// двигать слайдер в соответсвии с положением пальца